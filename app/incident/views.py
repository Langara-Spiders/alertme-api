            ...
            return JsonResponse(
                {
                    "message": MESSAGES[lng].get(
                        "SUCCESS_MESSAGE_FOR_INCIDENT_CATEGORY"
                    ),
                    "data": category_list,
                    "error": False,
            ...
            return JsonResponse(
                {
                    ...
                    .get("ERROR_MESSAGE_FOR_INCIDENT_CATEGORY")
                    .format(str(e)),
                    "data": None,
                    "error": True,
...
class IncidentView(View):
    ...
    def delete(self, request):
        ...
        return JsonResponse(
            {
                "message": MESSAGES[lng].get(
                    "SUCCESS_MESSAGE_INCIDENT_DELETED"
                ),
                "error": False,
                "status": HTTPStatus.OK,
            },
